use utf8;
package wkp::Schema::Result::Donations2010Candidate;
...
__PACKAGE__->table("donations_2010_candidates");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "donations_2010_candidates_id_seq",
  },
  "data_hora",
  {
    data_type   => "text",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eeGJW0EobyWEA2cup9PXdQ
